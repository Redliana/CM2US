...
async def call_openai_api(prompt: str, model: str = "gpt-4") -> Optional[str]:
    ...
    payload = {
        "model": model,
        "messages": [
            {"role": "system", "content": "You are a helpful research assistant that summarizes academic papers clearly and concisely."},
...
Please provide a clear, structured summary in 3-4 paragraphs."""
    ...
    if not summary:
        return f"Error: Failed to generate summary using {llm_provider}. Check API key and try again."
